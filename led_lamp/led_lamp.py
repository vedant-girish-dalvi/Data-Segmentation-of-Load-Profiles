...
def find_segments(time, current, voltage, threshold):
    ...
    if start_time is not None:
        end_time = time[-1]
        seq_count += 1
        segments.append((seq_count, "CC", max_voltage, max_current, 0, 0, start_time, end_time, end_time - start_time))
...
if __name__ == "__main__":
    ...
    excel_file_path = "ledlamp-2023-08-25-11-22-48-Transient-Scope.xlsx"
