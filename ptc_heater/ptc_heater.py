...
if __name__ == "__main__":
    ...
    excel_file_path = "ptcheater-2023-08-25-11-14-02-Transient-Scope.xlsx"
    ...
    result_df = insert_zero_current_rows(start, end, f"{excel_file_path.split('-')[0]}_report.xlsx",r"C:/Users/DAV1SI/Downloads/results.xlsx")
